...
$conect = mysqli_connect($endereco, $usuario, $senha, $nome);
	...
	while($linha = mysqli_fetch_assoc($dados)){
    	...
    	//configura a fonte
		$fpdf->setFont('arial','B',12);
		$fpdf->Cell(0,05,$linha['id'],0,1,'L');
		
		//configura a fonte Label.........
		$fpdf->setFont('arial','B',12);
		$fpdf->Cell(70,05,converte("Nome do funcionario:"),0,0,'L');
	
    	//configura a fonte
		$fpdf->setFont('arial','B',12);
		$fpdf->Cell(0,05,$linha['nome'],0,1,'L');
		...
		//configura a fonte Label.........
		$fpdf->setFont('arial','B',12);
		$fpdf->Cell(70,05,converte("Data de Nascimento:"),0,0,'L');
	
    	//configura a fonte
		$fpdf->setFont('arial','B',12);
		$fpdf->Cell(0,05,$linha['data_nascimento'],0,1,'L');
    	...
    	//configura a fonte
		$fpdf->setFont('arial','B',12);
		$fpdf->Cell(0,05,$linha['funcao_profissao'],0,1,'L');
